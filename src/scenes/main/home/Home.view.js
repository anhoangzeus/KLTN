  ...
  return (
    <SafeAreaView style={styles.screenContainersafe}>
      <View style={styles.screenContainer}>
        <StatusBar backgroundColor="#2B4F8C" barStyle="light-content" translucent={false} />
        ...
        <View style={styles.bodyContainer}>
          <ScrollView
            ...
            <View style={styles.proHotContainer}>
              ...
              <FlatList horizontal={true} numberOfLines={2} showsHorizontalScrollIndicator={false}
                data={listphone}
                renderItem={({ item }) => (
            ...
            <View style={styles.proHotContainer}>
              <Text style={{ fontSize: 18, color: 'black', marginVertical: 10 }}>
                <Foundation name="burst-new" color="red" size={25} /> Breads-Bakery Hot Sale
              </Text>
              <FlatList horizontal={true} numberOfLines={2} showsHorizontalScrollIndicator={false}
                data={listtablet}
                renderItem={({ item }) => (
            ...
            <View style={styles.proHotContainer}>
              <Text style={{ fontSize: 18, color: 'black', marginVertical: 10 }}>
                <Foundation name="burst-new" color="red" size={25} /> Snack Foods Hot Sale
              </Text>
              <FlatList
                horizontal={true}
                numberOfLines={2}
            ...
            <Text style={{ fontSize: 18, color: 'black', marginVertical: 10 }}>
              <Foundation name="burst-new" color="red" size={25} /> Sản phẩm nhà bán lẻ
            </Text>
