        ...
        return (
            <View style={styles.itemcard}>
                ...
                <View style={styles.flexRow}>
                    <FontAwesome name="gift" color="green" size={24} style={styles.itemGift} />
                ...
                <View style={styles.itemInfo}>
                    ...
                    <View style={styles.itemDec}>
                        <Text style={styles.txtPrice}><ReactNativeNumberFormat value={item.Price} /></Text>
                        <View style={styles.flexRow}>
                            <TouchableOpacity style={styles.buttonUpDown} onPress={() => { _giamSoLuong(item); }}>
                                <Text style={styles.btnGiamTang}>-</Text>
                            </TouchableOpacity>
                            <View style={styles.margin10}><Text style={styles.txtCount}>{item.Quantity}</Text></View>
                            <TouchableOpacity title="+" style={styles.buttonUpDown} onPress={() => { _tangSoLuong(item); }}>
                                <Text style={styles.btnGiamTang}>+</Text>
                            </TouchableOpacity>
                        </View>
                    </View>
                    ...
                    <TouchableOpacity style={styles.btnRemoveItem}
                        onPress={() => { setModalVisible(true); set_idCanXoa(item.Id); }}>
    ...
    return (
        <View style={styles.screenContainer}>
            ...
            <View style={styles.headerContainer}>
                <TouchableOpacity style={{ width: 75 }} onPress={() => navigation.navigate(SCENE_NAMES.MAIN)}>
                ...
                {hasAddress ?
                    <View style={styles.listItem}>
                        <View style={{ flex: 1, margin: 10 }}>
                            ...
                            <Text style={styles.address}>{Address.NumberAddress}, {Address.Xa}, {Address.Huyen}, {Address.City}</Text>
                            <Text style={styles.address}>{Address.ShipName} - {Address.ShipPhone}</Text>
                    ...
                    <View style={styles.listItem}>
                        <TouchableOpacity
                            onPress={() => { navigation.navigate('DetailAddressScreen', { id: '' }); }}
                ...
                </View>
                {
                    amount === 0 ?
                        <View style={styles.imageView}>
                            <Image source={require('assets/images/logoAn-03.png')} style={styles.img} />
            ...
            <View style={styles.TotalContainer}>
                <View flexDirection="row" justifyContent="space-between">
                    ...
                    <Text color="red" style={styles.txtPromotion}><ReactNativeNumberFormat value={amount} /></Text>
                </View>
                <TouchableOpacity style={styles.btnSubmit} onPress={() => { _checkGioHang(); }} >
                    <Text style={styles.txtCreatOrder}>Tiến hành đặt hàng</Text></TouchableOpacity>
            </View>
