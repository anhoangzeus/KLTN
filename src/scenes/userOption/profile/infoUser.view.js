                        ...
                        {isSelected ?
                            (
                                <View style={styles.userContainer1}>
                                    ...
                                    <View style={styles.magin10}>
                                        <Text style={data.check_textInputNewpass ? styles.welcomeText : styles.errtext1}>Mật khẩu mới</Text>
                                        <View style={styles.row}>
                                            <TextInput
                                    ...
                                    <View style={styles.magin10}>
                                        <Text style={data.check_textInputComfim ? styles.welcomeText : styles.errtext1}>Xác nhận mật khẩu mới</Text>
                                        <View style={styles.row}>
                                            <TextInput
