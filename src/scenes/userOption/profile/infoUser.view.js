    ...
    return (
        ...
        <SafeAreaView style={styles.screenContainer}>
                    ...
                    <View style={styles.userContainer}>
                        <View style={styles.textContainer}>
                            ...
                            <View style={styles.totalContainer1}>
                                ...
                                <TouchableOpacity style={styles.btnConfirmPhone} onPress={() => { auth().verifyPhoneNumber(data.Phone); }}>
                    ...
                    {isSelected ?
                        (
                            <View style={styles.userContainer1}>
                                <View style={styles.magin10}>
                                    <Text style={data.check_textInputOldpass ? styles.errtext : styles.errtext1}>Mật khẩu cũ</Text>
                                    <View style={styles.row}>
                                        <TextInput
                                ...
                                <View style={styles.magin10}>
                                    <Text style={data.check_textInputNewpass ? styles.errtext : styles.errtext1}>Mật khẩu mới</Text>
                                    <View style={styles.row}>
                                        <TextInput
                                ...
                                <View style={styles.magin10}>
                                    <Text style={data.check_textInputComfim ? styles.errtext : styles.errtext1}>Xác nhận mật khẩu mới</Text>
                                    <View style={styles.row}>
                                        <TextInput
            ...
            <View style={styles.btnSave}>
                <TouchableOpacity style={styles.btnTouch} onPress={() => { saveChangesHandle(); }}>
