...
export default function AddressView(props) {
    ...
    const RenderList = ({ NumberAddress, Xa, City, Huyen, ShipName, ShipMoblie, id, Main }) => (
        <TouchableOpacity style={styles.listItem} onPress={() => { NavigationServices.navigate(SCENE_NAMES.DETAIL_ADDRESS, { content: id }); }}>
                    ...
                    <View style={{ flexDirection: 'row' }}>
                        {
                            Main ? null :
                                <TouchableOpacity
                                    style={styles.btnAdd}
                                    onPress={() => { setModalVisible(true); set_idCanXoa(id); setIsMain(Main); }}
                                >
    ...
    const RenderNull = () => {
        return (
            <View style={styles.nullContainer}>
                ...
                <TouchableOpacity
                    onPress={() => { NavigationServices.navigate(SCENE_NAMES.DETAIL_ADDRESS, { content: '' }); }}
