...
import styles from './confim_order.styles';
      ...
      <View style={styles.screenContainer}>
        ...
        <ScrollView>
          ...
          <View
            ...
            <View
              style={{height: 2, backgroundColor: '#1e88e5', marginTop: 2}}
            />
        ...
        <Modal
          ...
          <View style={styles.centeredView}>
            <View
              style={{...styles.modalView, padding: SIZE.DEVICE_WIDTH / 15}}>
...
export default ConfimOrderView;
